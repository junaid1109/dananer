...
Route::namespace('App\Http\Controllers\Admin\Auth')->name('admin.')->group(function () {
...
Route::middleware('admin')->group(function () {
    Route::controller('App\Http\Controllers\Admin\AdminController')->group(function () {
        ...
        Route::get('chart/return-amount', 'returnAmountReport')->name('chart.return.amount');
    ...
    // Users Manager
    Route::controller('App\Http\Controllers\Admin\ManageUsersController')->group(function () {
        Route::get('/users', 'allUsers')->name('all');
        Route::get('users/active', 'activeUsers')->name('active');
        Route::get('users/banned', 'bannedUsers')->name('banned');
        Route::get('users/email-verified', 'emailVerifiedUsers')->name('email.verified');
        Route::get('users/email-unverified', 'emailUnverifiedUsers')->name('email.unverified');
        Route::get('users/mobile-unverified', 'mobileUnverifiedUsers')->name('mobile.unverified');
        Route::get('users/kyc-unverified', 'kycUnverifiedUsers')->name('kyc.unverified');
        Route::get('users/kyc-pending', 'kycPendingUsers')->name('kyc.pending');
        Route::get('users/mobile-verified', 'mobileVerifiedUsers')->name('mobile.verified');
        Route::get('users/with-balance', 'usersWithBalance')->name('with.balance');
    ...
    // Miner
    Route::controller('App\Http\Controllers\Admin\MinerController')->group(function () {
        Route::get('miners', 'index')->name('miner.index');
        Route::get('miner/plans/{id}', 'plans')->name('miner.plans');
        Route::post('miner/store/{id?}', 'store')->name('miner.store');
    });

    // Plans
    Route::controller('App\Http\Controllers\Admin\PlanController')->group(function () {
    ...
    // Subscriber
    Route::controller('App\Http\Controllers\Admin\SubscriberController')->prefix('subscriber')->name('subscriber.')->group(function () {
    ...
    Route::name('gateway.')->prefix('gateway')->group(function () {
        // Automatic Gateway
        Route::controller('App\Http\Controllers\Admin\AutomaticGatewayController')->prefix('automatic')->name('automatic.')->group(function () {
            Route::get('/', 'index')->name('index');
        ...
        // Manual Methods
        Route::controller('App\Http\Controllers\Admin\ManualGatewayController')->prefix('manual')->name('manual.')->group(function () {
            Route::get('/', 'index')->name('index');
    ...
    // PAYMENT
    Route::controller('App\Http\Controllers\Admin\ManagePaymentController')->name('payment.')->prefix('payment')->group(function () {
        Route::get('/', 'payment')->name('list');
    ...
    Route::name('withdraw.')->prefix('withdraw')->group(function () {
        Route::controller('App\Http\Controllers\Admin\WithdrawalController')->name('data.')->group(function () {
    ...
    // Report
    Route::controller('App\Http\Controllers\Admin\ReportController')->prefix('report')->name('report.')->group(function () {
        Route::get('transaction/{user_id?}', 'transaction')->name('transaction');
        Route::get('login/history', 'loginHistory')->name('login.history');
        Route::get('login/ipHistory/{ip}', 'loginIpHistory')->name('login.ipHistory');
        Route::get('notification/history', 'notificationHistory')->name('notification.history');
        Route::get('email/detail/{id}', 'emailDetails')->name('email.details');
        Route::get('referral/bonus/log', 'referralBonusLog')->name('referral.bonus.log');
    });


    // Admin Support
    Route::controller('App\Http\Controllers\Admin\SupportTicketController')->prefix('ticket')->name('ticket.')->group(function () {
    ...
    // Language Manager
    Route::controller('App\Http\Controllers\Admin\LanguageController')->prefix('language')->name('language.')->group(function () {
    ...
    Route::controller('App\Http\Controllers\Admin\GeneralSettingController')->group(function () {
    ...
    Route::controller('App\Http\Controllers\Admin\ReferralController')->name('setting.')->group(function () {
        Route::get('referral', 'index')->name('referral');
        Route::post('referral-update', 'update')->name('referral.update');
    });


    Route::controller('App\Http\Controllers\Admin\CronConfigurationController')->name('cron.')->prefix('cron')->group(function () {
        Route::get('/', 'cronJobs')->name('index');
    ...
    //KYC setting
    Route::controller('App\Http\Controllers\Admin\KycController')->group(function () {
        Route::get('kyc-setting', 'setting')->name('kyc.setting');
        Route::post('kyc-setting', 'settingUpdate');
    });

    //Notification Setting
    Route::name('setting.notification.')->controller('App\Http\Controllers\Admin\NotificationController')->prefix('notification')->group(function () {
        //Template Setting
    ...
    // Plugin
    Route::controller('App\Http\Controllers\Admin\ExtensionController')->prefix('extensions')->name('extensions.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // SEO
    Route::get('seo', 'App\Http\Controllers\Admin\FrontendController@seoEdit')->name('seo');


    // Frontend
    Route::name('frontend.')->prefix('frontend')->group(function () {

        Route::controller('App\Http\Controllers\Admin\FrontendController')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('templates', 'templates')->name('templates');
        ...
        // Page Builder
        Route::controller('App\Http\Controllers\Admin\PageBuilderController')->group(function () {
