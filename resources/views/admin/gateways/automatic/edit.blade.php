...
@section('panel')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ url('admin/gateway/automatic/update', $gateway->code) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="content">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger confirmationBtn" data-question="@lang('Are you sure to delete this gateway currency?')" data-action="{{ url('admin/gateway/automatic/remove', $gatewayCurrency->id) }}">
...
@push('breadcrumb-plugins')
    <x-back route="{{ url('admin/gateway/automatic') }}" />
@endpush
