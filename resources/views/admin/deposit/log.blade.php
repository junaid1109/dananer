...
@section('panel')
    <div class="row justify-content-center">
        @if (request()->routeIs('admin.payment.list') || request()->routeIs('admin.payment.method'))
            <div class="col-12">
                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.payment.details', $deposit->id) }}" class="btn btn-sm btn-outline--primary ms-1">
