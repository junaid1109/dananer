    ...
    <div class="modal fade" id="addModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/miner/store') }}" method="POST">
                    @csrf
            ...
            <div class="modal-content">
                ...
                <form id="editForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('Features')</label>
                            <select class="form-control select2-auto-tokenize" name="features[]" multiple="multiple"></select>
                        </div>
...
@push('breadcrumb-plugins')
    ...
    @else
        <a class="btn btn-sm btn-outline--dark" href="{{ url('admin/miners') }}"><i class="las la-undo"></i>@lang('Back')</a>
    @endif
@endpush
    ...
    <script>
        ...
        (function($) {
            ...
            $('.editBtn').on('click', function() {
                ...
                form.action = '{{ url('admin/plan/update', '') }}' + '/' + plan.id;
