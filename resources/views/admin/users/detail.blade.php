    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.payment.list', $user->id) }}" title="Total Payments" icon="las la-wallet" value="{{ showAmount($totalDeposit) }}" bg="8" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.withdraw.data.all', $user->id) }}" title="Successful Withdrawals" icon="las la-wallet" value="{{ $totalWithdrawal }}" bg="9" type="2" />
                </div>
