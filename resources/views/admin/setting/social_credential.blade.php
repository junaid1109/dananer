                                            ...
                                            <div class="button--group">
                                                ...
                                                @if (@$credential->status == Status::ENABLE)
                                                    <button class="btn btn-outline--danger btn-sm confirmationBtn"
                                                        ...
                                                        data-action="{{ url('admin/setting/social/credentials/status', $key) }}">
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                let modal = $('#editModal');
                let data = $(this).data();
                let route = "{{ url('admin/setting/social/credentials/update/', '') }}";
                let callbackUrl = "{{ url('user/social-login/callback', '') }}";
