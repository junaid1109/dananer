    ...
    @if (@$section->content)
        <div class="row">
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('admin/frontend/frontend-content', $key) }}" class="disableSubmission" method="POST" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    @if (@$section->element->seo)
                                                        <a href="{{  url('admin/frontend/sections/element/seo', [$key, $data->id]) }}" class="btn btn-sm btn-outline--info"><i class="la la-cog"></i> @lang('SEO Setting')</a>
                                                    @endif
                                                    ...
                                                    @else
                                                        <a href="{{  url('admin/frontend/sections/element', [$key, $data->id]) }}" class="btn btn-sm btn-outline--primary"><i class="la la-pencil-alt"></i> @lang('Edit')</a>
                                                    @endif
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn" data-action="{{  url('admin/frontend/remove', $data->id) }}" data-question="@lang('Are you sure to remove this item?')"><i class="la la-trash"></i> @lang('Remove')</button>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
        ...
        <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{  url('admin/frontend/sections/content', $key) }}" class="disableSubmission" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{  url('admin/frontend/sections/content', $key) }}" class="edit-route disableSubmission" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="type" value="element">
...
@push('breadcrumb-plugins')
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center">
        @if (@$section->element)
            ...
            @else
                <a href="{{  url('admin/frontend/sections/element', $key) }}" class="btn btn-sm btn-outline--primary"><i class="las la-plus"></i>@lang('Add New')</a>
            @endif
        @endif
        @if (!empty($templates))
            <div class="form-inline float-sm-end">
                <form action="{{  url('admin/frontend/import', $key) }}" method="post">
                    <div class="input-group">
                        @csrf
        ...
        @if (!@$section->hide_builder)
            <x-back route="{{  url('admin/frontend') }}" />
        @endif
    </div>
@endpush
