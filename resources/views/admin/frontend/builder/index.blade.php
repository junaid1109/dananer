    ...
    @if ($pData->is_default == Status::NO)
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('admin/frontend/manage-pages/update') }}" method="POST">
                            @csrf
        ...
        <div class="col-6 col-lg-6 col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/frontend/manage-section', $pData->id) }}" method="post">
                        @csrf
                                ...
                                <li class="highlight icon-move clearfix" data-key="{{ $k }}">
                                    ...
                                    @if ($secs['builder'])
                                        <div class="float-end d-inline-block manage-content">
                                            <a class="btn cog-btn text-center" href="{{ url('admin/frontend/sections', $k) }}" target="_blank">
        ...
        (function($) {
            ...
            $('[name=slug]').on('input', function() {
                ...
                if (slug) {
                    ...
                    `);
                    $.get("{{ url('admin/frontend/manage-pages/check-slug/', $pData->id) }}", {
                        slug: slug
                    }, function(response) {
                        if (!response.exists) {
                            $('.slug-verification').html(`
...
@push('breadcrumb-plugins')
    <x-back route="{{ url('admin/frontend/manage-pages') }}" />
@endpush
