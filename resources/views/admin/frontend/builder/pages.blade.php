                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            <a href="{{  url('admin/frontend/manage-seo',$data->id) }}" class="btn btn-sm btn-outline--info"><i class="la la-cog"></i> @lang('SEO Setting')</a>
                                            <a href="{{  url('admin/frontend/manage-section', $data->id) }}" class="btn btn-sm btn-outline--primary"><i class="la la-pen"></i> @lang('Edit')</a>
                                            @if($data->is_default == Status::NO)
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                data-action="{{  url('admin/frontend/manage/pages.delete',$data->id) }}"
    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{  url('admin/frontend/manage-pages')}}" class="disableSubmission" method="POST">
                    @csrf
        ...
        (function ($) {
            ...
            $('[name=slug]').on('input',function(){
                ...
                if (slug) {
                    ...
                    `);
                    $.get("{{  url('admin/frontend/manage-pages/check-slug/') }}", {slug:slug},function(response){
                        if (!response.exists) {
                            $('.slug-verification').html(`
