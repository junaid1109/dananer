...
@section('panel')
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ url('admin/users') }}" icon="las la-users" title="Total Users" value="{{ $widget['total_users'] }}" color="primary" icon_style="solid" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ url('admin/users/active') }}" icon="las la-user-check" title="Active Users" value="{{ $widget['verified_users'] }}" color="success" icon_style="solid" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ url('admin/users/email-unverified') }}" icon="lar la-envelope" title="Email Unverified Users" value="{{ $widget['email_unverified_users'] }}" color="danger" icon_style="solid" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ url('admin/users/mobile-unverified') }}" icon="las la-comment-slash" title="Mobile Unverified Users" value="{{ $widget['mobile_unverified_users'] }}" color="warning" icon_style="solid" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_miner'] }}" title="Total Miner" style="2" color="info" icon_style="solid" link="{{ url('admin/miners') }}" icon="la la-hammer" icon_style="solid" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_plan'] }}" title="Total Mining Plan" style="2" color="primary" icon_style="solid" link="{{ url('admin/mining-plans') }}" icon="la la-list" icon_style="solid" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_sale_count'] }}" title="Total Sale" style="2" color="success" icon_style="solid" link="{{ url('admin/mining-tracks') }}" icon="la la-list-alt" icon_style="solid" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ showAmount($widget['total_sale_amount']) }}" title="Total Sale Amount" style="2" color="dark" icon_style="solid" link="{{ url('admin/mining-tracks') }}" icon="la la-money-bill" icon_style="solid" />
...
@push('script')
    <script>
        ...
        const returnAmountChart = (startDate, endDate) => {
            ...
            const url = @json(url('admin.chart.return.amount'));
        ...
        const transactionChart = (startDate, endDate) => {
            ...
            const url = @json(url('admin.chart.transaction'));
