                    ...
                    <div class="contact-form @if (!gs('registration')) form-disabled @endif">
                        ...
                        <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha disableSubmission">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form--control" placeholder="@lang('Last Name')" name="lastname" value="{{ old('lastname') }}" required>
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="email" placeholder="@lang('E-Mail Address')" class="form--control checkUser" name="email" value="{{ old('email') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form--control @if (gs('secure_password')) secure-password @endif" id="your-password" name="password" type="password" placeholder="@lang('Enter Password')" required>
