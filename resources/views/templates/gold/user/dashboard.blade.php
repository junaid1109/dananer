...
@section('content')
            ...
            @if (auth()->user()->kv == Status::KYC_UNVERIFIED && auth()->user()->kyc_rejection_reason)
                <div class="alert alert-danger" role="alert">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn--base pill btn--sm" data-bs-toggle="modal"
    ...
    <div class="row gy-4 justify-content-center">
        ...
        <div class="col-lg-4 col-sm-6 col-xsm-6">
            <div class="dashboard-widget flex-align">
                <span class="dashboard-widget__icon flex-center before-shadow"><span
            ...
            <div class="col-lg-4 col-sm-6 col-xsm-6">
                <div class="dashboard-widget flex-align">
                    <span class="dashboard-widget__icon flex-center before-shadow">
                        <img alt="@lang('Image')"
                            src="{{ getImage(getFilePath('miner') . '/' . $item->coin_image, getFileSize('miner')) }}">
                    </span>
                    <div class="dashboard-widget__content">
