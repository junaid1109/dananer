        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <form action="{{ route('user.deposit.insert') }}" method="post" class="deposit-form">
                    ...
                    <input type="hidden" class="amount" name="amount" value="{{ getAmount($order->amount) }}">
                                ...
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text mb-0">@lang('Mining Plan')</p>
                                        </div>
                                        <div class="deposit-info__input">
                                            <p class="text">{{ __($order->plan_details->title) }}</p>
                                        </div>
                                    </div>
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                        ...
                                        <div class="deposit-info__input">
                                            <p class="text">{{ showAmount($order->amount) }}</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="deposit-info">
